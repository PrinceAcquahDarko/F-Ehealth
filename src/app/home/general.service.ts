...
export class GeneralService {
  ...
  registerUser(data: Iregister): Observable<any> {
    return this.http
      .post<Iregister>(this.url + '/api-register', data)
      .pipe(catchError(this.handleError));
  }

  getAllHealthUsers(): Observable<any> {
    return this.http
      .get<Iregister>(this.url + '/api-register')
      .pipe(catchError(this.handleError));
  }
  ...
  getSingleUser(): Observable<any> {
    ...
    return this.http
      .get<Iregister>(this.url + '/api-register/id' + '?id=' + userId)
      .pipe(catchError(this.handleError));
  }
  ...
  updateUser(data): Observable<any> {
    ...
    const userId = lstorage.num;
    return this.http
      .put<Iregister>(this.url + '/api-register' + '?id=' + userId, data)
      .pipe(catchError(this.handleError));
  }

  loginUser(data: Ilogin): Observable<any> {
    return this.http
      .post<Ilogin>(this.url + '/api-login', data)
      .pipe(catchError(this.handleError));
  }
